...
public class SearchRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof SearchViewHodler) {
            ...
            if (TextUtils.isEmpty(searchBookItemList.get(position).getISBN())) {
                doubanBookCoverImage.setId(String.valueOf(position));
            } else
            ...
            ((SearchViewHodler) holder).textViewBookISBN.setText("I S B N:" + searchBookItemList.get(position).getISBN());
