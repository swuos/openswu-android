...
public class CommonUtils {
    ...
    public static String getIMEI() {
        TelephonyManager tm = (TelephonyManager) App.getInstance().getSystemService(Service.TELEPHONY_SERVICE);
    ...
    public static int getScreenDPI() {
        if (m_screenDPI == -1) {
            ...
            WindowManager wndMgr = (WindowManager) App.getInstance().getSystemService(Context.WINDOW_SERVICE);
